...
// --- edited on 17-12-11
public $widthOriginal;     # Always be the original width
...
public function blur($arg){
	if ($this->imageResized) {
		...
		$off=0;
		imageconvolution($this->imageResized,$matrix,$div,$off);
	}
}

public function sharp($arg){
	if ($this->imageResized) {
		imagealphablending($this->imageResized,false);
		imagesavealpha($this->imageResized,true);
...
public function bright($arg){
	if ($this->imageResized) {
		imagealphablending($this->imageResized,false);
		imagesavealpha($this->imageResized,true);
		imagefilter($this->imageResized,IMG_FILTER_BRIGHTNESS,$arg);
	}
}
...
public function contrast($arg){
	if ($this->imageResized) {
		imagealphablending($this->imageResized,false);
		imagesavealpha($this->imageResized,true);
		imagefilter($this->imageResized,IMG_FILTER_CONTRAST,$arg);
	}
}
