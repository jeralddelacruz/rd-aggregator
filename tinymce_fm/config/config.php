...
$upload_dir = '/upload/'.$_SESSION["UserID"].'/fm/src/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/'.$_SESSION["UserID"].'/fm/src/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../upload/'.$_SESSION["UserID"].'/fm/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai','chm'); //Files
