...
$dir_arr=array();
$dir_arr=json_decode(file_get_contents($aie_api_url."/?func=dir&type=vbg"));
$icon_arr=json_decode(file_get_contents($aie_api_url."/?func=dir&type=icon"));
$inc_arr=array("Arrows","Bullets","Check Marks","Clouds","Computer Media","Dollar Signs","Holidays","Icons 1","Icons 2","Numbers","Holidays");
...
<script>
jQuery(function($){
	$("head").append("<script src='<?php echo $aie_dir;?>/aie_atl.js'><\/script>");
...
<div id="aie-thumb">
<input id="btnBgChangeCancel" type="button" value="Cancel" class="aie-btn" style="margin:5px 0;" />
	<ul>
...
<div id="aie-thumb-upload-sub"></div>
	...
	<div id="aie-thumb-color" class="ac">
		<div id="aie-grad-wrap">
			<p class="desc">Pick up Start and End colors for the Background Gradient. Make the colors equal for invariable Background.</p><br />
...
<div id="aie-menu" class="aie-hide">
	<div id="aie-menu-main">
		...
		<img id="btnSave" src="<?php echo $aie_dir;?>/img/btnsave.png" title="Save Slide" class="aie-img tip" />
		<img id="btnCancel" src="<?php echo $aie_dir;?>/img/btncancel.png" title="Cancel" class="aie-img tip" />
		<input id="btnBgChange" type="button" value="Change Background" class="aie-btn" />
