...
class gd_gradient {
	...
	function gd_gradient($w,$h,$d,$s,$e,$step=0) {
		$this->width = $w;
		$this->height = $h;
		$this->direction = $d;
		$this->startcolor = $s;
		...
		// Fill it
		$this->fill($this->direction,$this->startcolor,$this->endcolor);
	...
	function fill($direction,$start,$end) {
		$im=$this->image;
