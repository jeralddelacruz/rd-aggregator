...
// 						else{
						...
						if($expire){
							...
							// ... and printing on JVZ...
							echo "Thanks for your Purchase, <b>$ccustname</b>. Below is your login details to Sign In at <b>$login_url</b><br /><br />E-mail Address: <b>$ccustemail</b><br />Password: <b>$pass</b><br /><br />You can change your Password at any time under My Profile tab in Member Control Panel.";
						}
					}
					// upgrade
					else{
