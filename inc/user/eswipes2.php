<?php
if(!ereg(";eswipes2;",$cur_pack["pack_ar"])){
	redirect("index.php?cmd=deny");
}

$prb_arr=$DB->get_pack();
$res=$DB->query("select * from $dbprefix"."tpl p WHERE tpl_id IN (" . implode(',', $DFY_2) . ") order by tpl_order");
		...
		<div class="col-md-12">
			<div class="card">
				<div class="header card-header">
					<h4 class="title">Extra Affiliate Links</h4>
					<!--<small>...</small>-->
				</div>
