			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex flex-row justify-content-between align-items-center">
						...
						<div class="p-2 <?= empty($passed_id) ? "mr-auto" : ""; ?>">
							<a class="btn btn-outline-secondary" href="index.php?cmd=pageb2"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Back to Campaigns Table</a>
						</div>
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-md-6">
							<a class="btn btn-outline-secondary btn-block" href="index.php?cmd=pageb2">
								<?php if(empty($passed_id)) : ?>
