...
<!-- Fontfaces CSS-->
<link href="../themes/css/font-face-<?= strtolower($THEME_FONT[0]['name']) ?>.css" rel="stylesheet" media="all">
...
<!-- Main CSS-->
<link href="../themes/css/theme.css" rel="stylesheet" media="all">

<!-- Custom CSS-->
<link href="../themes/css/Theme_3/theme_3.css?v=<?= rand(1, 1000); ?>" rel="stylesheet" media="all">
...
<?php if (fontTheme() == 'raleway') : ?>
    ...
    <style>
        body, h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, p, .navbar, .brand, .btn-simple, .alert, a, .td-name, td, button.close { font-family: "Oswald", sans-serif !important; }
    </style>
    <?php elseif (fontTheme() == 'josefin') : ?>
    <style>
        body, h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, p, .navbar, .brand, .btn-simple, .alert, a, .td-name, td, button.close { font-family: "Josefin Sans", sans-serif !important; }
    </style>
    <?php elseif (fontTheme() == 'livvic') : ?>
    <style>
        body, h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, p, .navbar, .brand, .btn-simple, .alert, a, .td-name, td, button.close { font-family: "Livvic", sans-serif !important; }
    </style>
    <?php elseif (fontTheme() == 'nunito') : ?>
    <style>
        body, h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, p, .navbar, .brand, .btn-simple, .alert, a, .td-name, td, button.close { font-family: "Nunito", sans-serif !important; }
    </style>
    <?php elseif (fontTheme() == 'teko') : ?>
    <style>
        body, h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, p, .navbar, .brand, .btn-simple, .alert, a, .td-name, td, button.close { font-family: "Teko", sans-serif !important; }
