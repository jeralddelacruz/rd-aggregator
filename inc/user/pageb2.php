			...
			<div class="card-header">
				<div class="d-flex flex-row justify-content-between align-items-center">
					...
					<div class="p-2 mr-auto">
						<a href="index.php?cmd=pagebedit2" class="btn btn-outline-secondary">Create New</a>
					</div>
				</div>
			</div>
			<div class="card-body">
						...
						<?php foreach($campaigns as $campaign) : ?>
							<tr>
								...
								<td class="text-center">
									<a href="index.php?cmd=pagebedit2&id=<?= $campaign["campaigns_id"]; ?>" class="btn btn-secondary">
