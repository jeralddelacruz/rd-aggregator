...
<html lang="en">
    <head>
        ...
        <?php if($WEBSITE["icon"]){ ?> <link rel="shortcut icon" href="../img/<?php echo $WEBSITE["icon"];?>" /> <?php } ?>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="card col-md-8 col-sm-10 col-xs-9" style="margin:0 auto;float:none;padding-bottom:5px;">
                        <div class="content text-center">
                            <a href="<?php echo $WEBSITE["sales_page_link"];?>" class="btn btn-<?php echo $WEBSITE["theme_btn"];?> btn-fill">Not yet a member?</a>&nbsp;
                            <a href="<?php echo $USERDIR; ?>" class="btn btn-<?php echo $WEBSITE["theme_btn"];?> btn-fill">Already a member?</a>
                        </div>
                    </div>
                </div>
            </div>
