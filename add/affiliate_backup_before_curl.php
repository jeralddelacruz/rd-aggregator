...
<html>
	...
	<body>
		<div class="cs-main-wrapper">
			...
			<div class="cs-body-absolute">
				<!-- PUT THIS AS AN ATTRIBUTE WHEN BYPASSING X-FRAME -->
				<!-- NOTE: SCRIPT CODE INCLUDED -->
				<!-- is="x-frame-bypass" -->
				<iframe id="affiliate-iframe" src="<?= $campaign["pageb_campaign_affiliate_link_final"]; ?>"></iframe>
			</div>
	...
	<script type="text/javascript">
		...
		redirection_overlay.onclick = function(){
			location.href = "<?= $campaign["pageb_campaign_affiliate_link_final"]; ?>";
		}
