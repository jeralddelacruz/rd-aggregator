...
<html class="cs-bg-color-gainsboro">
	<head>
		<title><?= $WEBSITE["sitename"]; ?> Javascript Widget</title>
	...
	<body>
		<!-- THIRD-PARTY CONTAINER SAMPLE -->
		<!-- NOTE: STYLE THE THIRD-PARTY CONTAINER ANY WAY YOU WANT -->
		<div id="third-party-container"></div>

		<!-- SCRIPT FOR WIDGET: USING CREATE ELEMENT -->
		<!-- <script type="text/javascript">
			// TARGET THIRD-PARTY CONTAINER
			var thirdPartyContainer = document.getElementById("third-party-container");

			// CREATING A NEW ELEMENT
			var createNewElement = document.createElement("iframe");
			createdElement = createNewElement;
			createdElement.src = "https://cppages.com/add/tests/javascript_widget/widget.php";
			createdElement.style.border = "none";
			createdElement.style.width = "100%";
			createdElement.style.height = "100%";
			thirdPartyContainer.parentNode.replaceChild(createdElement, thirdPartyContainer);
		</script> -->

		<!-- MINIFIED -->
		<script type="text/javascript">var thirdPartyContainer=document.getElementById("third-party-container");var createNewElement=document.createElement("iframe");createdElement=createNewElement;createdElement.src="https://commissionshortcut.info/mhfu/";createdElement.style.border="none";createdElement.style.width="100%";createdElement.style.height="100%";thirdPartyContainer.parentNode.replaceChild(createdElement,thirdPartyContainer);</script>

		<!-- SCRIPT FOR WIDGET: USING AJAX -->
		<!-- DISPLAYING: BUT FORM NOT WORKING -->
		<!-- <script type="text/javascript">
			function loadWidget(){
				var response = null;
				var filePath = "https://cppages.com/add/tests/javascript_widget/widget.php";
			...
			var thirdPartyContainer = document.getElementById("third-party-container");
			thirdPartyContainer.innerHTML = loadWidget();
		</script> -->
	</body>
</html>