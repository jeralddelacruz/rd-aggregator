...
<html class="cs-bg-color-gainsboro">
	...
	<body>
		<div class="cs-main-wrapper">
			<div class="cs-text-headline">Sample Widget</div>

			<?php if($_POST["submit"]) : ?>
			<div class="cs-text-subheadline">Yes! It works!</div>
			<?php endif; var_dump($_POST["widget_input"]); ?>

			<form method="POST" enctype="multipart/form-data">
				<input class="cs-form-control" type="text" name="widget_input" value="" />
				<input class="cs-form-button" type="submit" name="submit" value="Submit" />
			</form>
		</div>
	</body>
</html>